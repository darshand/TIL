## We can generate controllers without assets tests or view templates while generating controllers. This will be helpfull when generating controllers for api controllers.
